...
namespace {
    ...
    class Resizer extends \App\Providers\Resizer\Facade{
        ...
        public static function getConfig(){
            return \App\Providers\Resizer\Resizer::getConfig();
        }
         ...
         * @static 
         */
        public static function getImagesDir($id = 0){
            return \App\Providers\Resizer\Resizer::getImagesDir($id);
        }
         ...
         * @static 
         */
        public static function moveToPermanentLocation($gallery = null, $configSet = 'dirs'){
            return \App\Providers\Resizer\Resizer::moveToPermanentLocation($gallery, $configSet);
        }
         ...
         * @static 
         */
        public static function gallery($gallery = null, $useEmptyImage = false){
            return \App\Providers\Resizer\Resizer::gallery($gallery, $useEmptyImage);
        }
         ...
         * @static 
         */
        public static function galleryString($gallery = array()){
            return \App\Providers\Resizer\Resizer::galleryString($gallery);
        }
        ...
        public static function load($file){
            return \App\Providers\Resizer\Resizer::load($file);
        }
         ...
         * @static 
         */
        public static function resize($newWidth, $newHeight, $crop = false){
            return \App\Providers\Resizer\Resizer::resize($newWidth, $newHeight, $crop);
        }
        ...
        public static function save($savePath){
            return \App\Providers\Resizer\Resizer::save($savePath);
        }
         ...
         * @static 
         */
        public static function addImage($filePath, $name = '', $tmp = false, $configSet = 'dirs'){
            return \App\Providers\Resizer\Resizer::addImage($filePath, $name, $tmp, $configSet);
        }
         ...
         * @static 
         */
        public static function deleteImages($gallery = null, $tmp = false, $configSet = 'dirs'){
            return \App\Providers\Resizer\Resizer::deleteImages($gallery, $tmp, $configSet);
        }
        
    }


    class Dictionary extends \App\Providers\Dictionary\Facade{
    ...
    class Date extends \App\Providers\Date\Facade{
         ...
         * @static 
         */
        public static function getInterval($date = null, $hour = 0, $min = 0, $sec = 0){
            return \App\Providers\Date\Date::getInterval($date, $hour, $min, $sec);
        }
